...
import com.example.sec18_128.databinding.FragmentNewsBinding
    ...
    private fun setSearchView() {
        fragmentNewsBinding.svNews.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                viewModel.searchNews("jp", query.toString(), page)
                viewSearchedNews()
                return false
            }
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                MainScope().launch {
                    delay(2000)
                    viewModel.searchNews("jp", newText.toString(), page)
                    viewSearchedNews()
                }
                return false
            }
